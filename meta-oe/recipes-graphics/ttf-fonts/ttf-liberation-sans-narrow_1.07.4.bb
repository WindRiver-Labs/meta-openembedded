...
SRC_URI = "http://dev-www.libreoffice.org/src/134d8262145fc793c6af494dcace3e71-liberation-fonts-ttf-${PV}.tar.gz;downloadfilename=liberation-fonts-ttf-${PV}.tar.gz \
